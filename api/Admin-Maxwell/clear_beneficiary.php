...
$delete_sql = "DELETE FROM beneficiary WHERE uid = ?";
...
if ($success) {
    // Get new count
    $count_sql = "SELECT COUNT(*) as count FROM beneficiary WHERE uid = ?";
    ...
    echo json_encode(['success' => false, 'message' => 'Failed to clear beneficiary list']);
}
?>